...
import MobileFAQGrid from "./MobileFAQGrid";
    ...
    return (
        ...
        <div className="bg-[#F4F8FB]  mx-4 flex justify-center items-center mb-2">
            ...
            >
                ...
                {/* Content Grid Desktop */}
                <div className="hidden md:grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-y-10 md:gap-x-12 lg:gap-x-20 lg:gap-y-16 max-w-7xl w-full mx-auto justify-items-center">
                ...
                {/* Content Grid Mobile */}
                <MobileFAQGrid benefits={benefitsMobile} />
            </section>
        </div>
