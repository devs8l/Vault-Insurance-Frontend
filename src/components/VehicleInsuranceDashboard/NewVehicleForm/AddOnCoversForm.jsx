...
const AddOnCoversForm = ({ onPrevious, onGetQuote }) => {
    ...
    // Function to get the display text for selected add-ons
    ...
    return (
        ...
        >
            ...
            {/* Progress Indicator (Third Step Active) */}
            <div className="flex w-full mb-8">
                <div className="flex-1 h-1 bg-[#6290FF] rounded-full mr-2"></div> {/* Completed */}
                <div className="flex-1 h-1 bg-[#6290FF] rounded-full mr-2"></div> {/* Completed */}
                <div className="flex-1 h-1 bg-[#6290FF] rounded-full"></div> {/* Current */}
            </div>

            <h3 className="text-[20px] font-semibold text-[#222] mb-6">Add-on Covers <span className="text-[#999] text-base">(Optional)</span></h3>

            <div className="grid grid-cols-1 gap-6 mb-8">
                {/* Select Add-On Covers Multi-select Dropdown */}
            ...
            {/* Previous and Get a Free Quote Buttons */}
